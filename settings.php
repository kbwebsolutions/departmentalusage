...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('departmentalusagereport/managerroleid',
                       get_string('chooseroleid', 'report_departmentalusage'),
                       get_string('descchooseroleid', 'report_departmentalusage'), 'defaultroleid', $roletypes));
